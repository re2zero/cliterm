# Phase1C: RPC server handlers in wshserver.go
...
Remove Cowork handler registrations from pkg/wshrpc/wshserver/wshserver.go and add Team handler implementations. Each handler delegates to the corresponding pkg/team/ function. Register all Team handlers in init().

# Phase1B: pkg/team/team_fork.go — Worker fork/recycle logic
...
Implement Worker fork and recycle logic. ForkWorker checks MaxConcurrency, generates runtime names (MemberName-N), creates DB entries. RecycleWorker updates status and records Activity. GetNextWorkerNumber provides atomic counter.

## Files to Modify

- pkg/team/team_fork.go

# Phase1C: RPC client stubs in wshclient.go
...
Remove Cowork client methods from pkg/wshrpc/wshclient/wshclient.go and add Team client methods following the existing pattern. Each method sends the RPC command and returns the response.

# Phase1E: Unit tests for pkg/team/
...
Create pkg/team/team_test.go with comprehensive unit tests. Cover: Member CRUD, Worker CRUD, Task CRUD, Activity logging, state machine validation, fork/recycle logic, config parsing. Target coverage >= 85%. Use raw testing package (no testify/gomock).

## Files to Modify

- pkg/team/team_test.go

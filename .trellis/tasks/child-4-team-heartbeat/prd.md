# Phase1B: pkg/team/team_heartbeat.go — Worker health check
...
Implement Worker heartbeat monitoring. CheckWorkerHealth queries active workers, checks PID via os.FindProcess, marks offline if dead. StartHeartbeatLoop runs periodic checks via goroutine with ticker.

## Files to Modify

- pkg/team/team_heartbeat.go

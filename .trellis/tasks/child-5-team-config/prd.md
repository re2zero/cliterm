# Phase1B: pkg/team/team_config.go — Config file system
...
Implement config file loading system. LoadGlobalTemplates reads ~/.waveterm/team-templates/*.yaml. LoadProjectConfig reads .wave/team.yaml. ParseMemberYAML unmarshals YAML to TeamMember. GetEffectiveConfig merges project + global. Include 4 built-in default templates.

## Files to Modify

- pkg/team/team_config.go

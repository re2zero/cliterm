# Phase1D: WPS events + tsgen updates
...
Update pkg/wps/wpstypes.go: rename Event_CoworkTaskUpdate→Event_TeamTaskUpdate, Event_CoworkWorkerUpdate→Event_TeamWorkerUpdate, add Event_TeamMemberUpdate. Update pkg/tsgen/tsgenevent.go with same renames. Update pkg/waveobj/objrtinfo.go: WaveAICoworkMode→WaveAITeamMode.

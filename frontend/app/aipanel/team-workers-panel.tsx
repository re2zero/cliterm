...
export function TeamWorkersPanel() {
    ...
    const loadData = async () => {
        ...
        try {
            const [workersData, tasksData] = await Promise.all([
                ...
                RpcApi.TeamListTasksCommand(TabRpcClient, {}),
            ]);
    ...
    return (
        <div className="border-t border-gray-700">
            <button
                ...
                className="w-full px-3 py-2 flex items-center justify-between text-sm text-gray-300 hover:bg-gray-800 transition-colors cursor-pointer"
            >
                ...
                <div className="px-3 pb-3">
                    {isLoading ? (
                        ...
                        <div className="text-xs text-gray-500 py-2">
                            No workers or tasks. Use AI to create and manage team members.
                        </div>
                    ) : (
                                            ...
                                            >
                                                ...
                                                {w.assignedtaskid && (
                                                    <div className="text-blue-400 pl-3">
                                                        → {w.assignedtaskid.substring(0, 15)}...
                                                    </div>
                                                )}
                                            </div>
                                        ))}

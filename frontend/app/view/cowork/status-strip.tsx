...
export function StatusStrip({ status }: { status: CoworkStatusData }) {
    const items = [
        { label: "Workers", value: `${status.activeworkers}/${status.totalworkers}`, color: "text-secondary", dot: "bg-green-500" },
